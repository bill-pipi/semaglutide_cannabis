...
pdf(file.path(workdir,"Figure2b.pdf"),  onefile=FALSE, width=10, height=5)
...
forestplot(labeltext=tabletext, 
           ...
           title ="Medical encounter for CUD diagnosis in patients with type 2 diabetes and a prior history of CUD \ncomparison between propensity-score matched cohorts during 12-month follow-up time period ", 
