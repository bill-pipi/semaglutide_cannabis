...
pdf(file.path(workdir,"Figure1b.pdf"),  onefile=FALSE, width=10, height=5)
...
forestplot(labeltext=tabletext, 
           ...
           title ="Medical encounter for CUD diagnosis in patients with obesity and a prior history of CUD \ncomparison between propensity-score matched cohorts during 12-month follow-up time period ", 
